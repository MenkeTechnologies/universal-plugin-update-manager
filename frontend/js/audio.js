...
async function toggleMetadata(filePath, event) {
  ...
  try {
    ...
    const closeBtn = `<button class="btn-small btn-stop" data-action="closeMetaRow" style="position:absolute;top:8px;right:8px;font-size:12px;padding:4px 8px;z-index:10;background:var(--bg-card);border:1px solid var(--border);cursor:pointer;" title="Close metadata panel">&#10005;</button>`;
