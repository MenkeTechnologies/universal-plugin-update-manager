...
| **`test/i18n-catalog-files.test.js`** | tally `rg -c '^test\\(' test/i18n-catalog-files.test.js` | `i18n/` contains exactly the five shipped `app_i18n_*.json` locales (no stray/extra locale files); files do not start with a UTF-8/Unicode BOM. |
...
test/
  ...
  i18n-catalog-files.test.js -- exact app_i18n_*.json set in i18n/; no BOM
