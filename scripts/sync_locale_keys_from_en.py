#!/usr/bin/env python3
"""Ensure i18n/app_i18n_{de,es,es_419,sv,fr,nl,pt,pt_br,it,el,pl,ru,zh,ja,ko,fi,da,nb,tr,cs,hu,ro,uk,vi,id,hi}.json contain every key from app_i18n_en.json.
