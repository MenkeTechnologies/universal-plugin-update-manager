#!/usr/bin/env python3
"""Build i18n/app_i18n_cs.json from app_i18n_en.json (Czech UI).
...
def restore_ipc_placeholders(en_val: str, loc_val: str) -> str:
    """Restore `{token}` spellings after MT corrupts brace segments."""
...
def main() -> None:
    try:
        ...
        print(
            ...
            ".venv-i18n/bin/pip install deep-translator && .venv-i18n/bin/python scripts/gen_app_i18n_cs.py",
            file=sys.stderr,
        )
        raise SystemExit(1) from None

    en_path = I18N_DIR / "app_i18n_en.json"
    out_path = I18N_DIR / "app_i18n_cs.json"
