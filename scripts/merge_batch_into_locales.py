#!/usr/bin/env python3
"""Merge keys from a batch JSON into de/es/es_419/sv/fr/nl/pt/pt_br/it/el/pl/ru/zh/ja/ko/fi/da/nb/tr/cs/hu/ro/uk/vi/id/hi using English values for new keys.
